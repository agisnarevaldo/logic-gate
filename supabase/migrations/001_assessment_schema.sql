...
-- This file contains the tables needed to store user progress, scores, and learning data
...
-- Note: Default learning materials will be initialized automatically 
-- when user first accesses the assessment system via the application
-- using the initializeUserProgress() function in assessment-utils.ts
